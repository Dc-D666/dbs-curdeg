...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/c/:id/settings/:sub', name: 'community-settings-sub', component: () => import('@/views/ChannelSettingsView.vue') },
...
const guardedNames = ['community-admin', 'community-ops', 'community-settings', 'community-settings-sub', 'notifications', 'dashboard', 'post-create']
